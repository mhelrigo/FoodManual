package mhelrigo.foodmanual.data.model;
...
public class Meal {
    ...
    public mhelrigo.foodmanual.domain.model.meal.Meal toDrinkDomain() {
        return new mhelrigo.foodmanual.domain.model.meal.Meal(
                idMeal,
                strMeal,
                strDrinkAlternate,
                strCategory,
