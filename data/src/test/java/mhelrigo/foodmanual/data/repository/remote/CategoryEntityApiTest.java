...
public class CategoryEntityApiTest {
    ...
    @Test
    public void getAll() {
        CategoriesEntity mocked = gson.fromJson(FAKE_CATEGORIES, CategoriesEntity.class);
        CategoriesEntity actual = categoryApi.getAll()
                .observeOn(Schedulers.io())
                .subscribeOn(AndroidSchedulers.mainThread())
                .blockingGet();

        assertEquals(actual.getCategories().size(), mocked.getCategories().size());
    }
